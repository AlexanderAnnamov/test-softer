...
import { setRequestFiles } from "../../redux/file-manager/slice";
import { IFile } from "../../models/IFile";
import FileItem from "../file-item";
import { fetchFiles } from "../../redux/file-manager/slice";
...
const FileManager: React.FC = () => {
  ...
  const { counterSuccessUp } = useSelector(selectUploadFiles);
  const requestFiles = useSelector((state: any) => state.fileManager.requestFiles);
